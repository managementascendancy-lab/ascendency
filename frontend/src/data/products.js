...
export const PRODUCTS = [
  ...
  },
  {
    ...
    eyebrow: "PRODUCT",
    tagline: "TWENTY HEROES. ONE PATH.",
    summary:
      "Twenty deterministic classifications, from NOVA to INFINITE. Every tier has fixed thresholds for speed, accuracy and consistency — nothing is graded on a curve.",
    features: [
      "Browse all twenty hero classifications and the exact WPM / accuracy / consistency thresholds each one requires.",
